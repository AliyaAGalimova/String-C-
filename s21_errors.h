...
/*
 * s21_errors.h содержит описание стандартных ошибок.
...
/*Description of errors for MacOS*/
#if defined(__APPLE__) && defined(__MACH__)
#define N_OF_ERRORS 106
#define DESCRIPTION_OF_ERRORS { \
        /*Number of error       Description of error*/\
        /*      0       */      "Undefined error: 0", \
...
/*Description of errors for Linux*/
#if defined(__linux__)
#define N_OF_ERRORS 133
#define DESCRIPTION_OF_ERRORS { \
           /*Number of error        Description of error*/\
        /*      0       */      "Success", \
        /*      1       */      "Operation not permitted", \
